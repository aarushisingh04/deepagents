...
## [0.3.0](https://github.com/aarushisingh04/deepagents/compare/langchain-quickjs==0.2.0...langchain-quickjs==0.3.0) (2026-06-12)


### ⚠ BREAKING CHANGES

* **quickjs:** add default `subagent` bridge ([#3850](https://github.com/aarushisingh04/deepagents/issues/3850))
* **quickjs:** remove `skills_backend` ([#3843](https://github.com/aarushisingh04/deepagents/issues/3843))

### Features

* **quickjs:** add default `subagent` bridge ([#3850](https://github.com/aarushisingh04/deepagents/issues/3850)) ([85fd7c2](https://github.com/aarushisingh04/deepagents/commit/85fd7c283da6744e403a01861e17e99e13e0f481))
* **quickjs:** add REPL persistence modes ([#3557](https://github.com/aarushisingh04/deepagents/issues/3557)) ([0cda6f3](https://github.com/aarushisingh04/deepagents/commit/0cda6f3ab28bc83cd16ec9fcc48229bdf6f2dc1a))
...
* **quickjs:** propagate return types ([#3210](https://github.com/aarushisingh04/deepagents/issues/3210)) ([e26bccb](https://github.com/aarushisingh04/deepagents/commit/e26bccbe81b4e3ff2f0332f56f683106e0bafd88))
...
* **quickjs:** auto-await final-expression Promise in eval REPL ([#3499](https://github.com/aarushisingh04/deepagents/issues/3499)) ([f7f894a](https://github.com/aarushisingh04/deepagents/commit/f7f894aa9f313cf8157bc6d7711013f5509d0b46))
* **quickjs:** remove `skills_backend` ([#3843](https://github.com/aarushisingh04/deepagents/issues/3843)) ([1159e50](https://github.com/aarushisingh04/deepagents/commit/1159e504abaeec4f81d5e777ecde6a6cee641edb))
* **quickjs:** scope REPL prompt sandbox bullet to the runtime ([#3528](https://github.com/aarushisingh04/deepagents/issues/3528)) ([1b395ab](https://github.com/aarushisingh04/deepagents/commit/1b395ab9699b1f384a85efeeef732ea7e4fc523a))
* **quickjs:** swarm subagent doesn't allow configuring middleware ([#3757](https://github.com/aarushisingh04/deepagents/issues/3757)) ([3394a9d](https://github.com/aarushisingh04/deepagents/commit/3394a9d9c7c89c0a28fa1328c9f6bae68a83ff14))
* **quickjs:** update system prompt snapshots ([#3450](https://github.com/aarushisingh04/deepagents/issues/3450)) ([9f9220d](https://github.com/aarushisingh04/deepagents/commit/9f9220d80737208faa9262c0bdfb3eeafc0e13c8))
...
* **quickjs:** release: 0.1.1 ([#3255](https://github.com/aarushisingh04/deepagents/issues/3255)) ([8125f71](https://github.com/aarushisingh04/deepagents/commit/8125f71a6ffd40b75a25c017e2b255eeb3be48a6))
